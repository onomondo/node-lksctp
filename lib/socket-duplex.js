...
const create = ({
  ...
  const currentLocalAddress = socketCommon.getLocalAddress({ native, fd });
  const currentRemoteAddress = socketCommon.getRemoteAddress({ native, fd });
  ...
  duplex.localFamily = currentLocalAddress.family;
  duplex.localAddress = currentLocalAddress.address;
  duplex.localPort = currentLocalAddress.port;

  duplex.remoteFamily = currentRemoteAddress.family;
  duplex.remoteAddress = currentRemoteAddress.address;
  duplex.remotePort = currentRemoteAddress.port;
